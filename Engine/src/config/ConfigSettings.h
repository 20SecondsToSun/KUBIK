	...
	namespace config
	{
		...
		public:
			...
			void load() override
			{
				...
				try	
				{
					logger().log("mainConfigObj.getPathsConfigPath() " + mainConfigObj.getPathsConfigPath());
				...
				try	
				{
					logger().log("mainConfigObj.getConstsConfigPath() " + mainConfigObj.getConstsConfigPath());
				...
				try	
				{
					logger().log("mainConfigObj.getParamsConfigPath() " + mainConfigObj.getParamsConfigPath());
			...
			void writeConfig()
			{
				...
				{			
					if (settingsChanged())
					{
						...
						logger().log("MAIN CONFIG DOESNT CHANGED");
